...
namespace console {
    ...
    * After called this function, click the "Show console device" underneath the simulator, copy and paste codes into anywhere of the Code Editor, then you could see the image by click the image icon ahead the first line of img`...`
    */
    ...
    /**
    * Take a snapshot of current Tilemap, and transfer its define codes to computer via usb connection. 
    * After called this function, click the "Show console Device" underneath the simulator, copy and paste codes from log textbox into anywhere of the Code Editor, then you could see the tilemap by click the icon ahead the first line of these codes
